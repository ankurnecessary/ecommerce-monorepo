  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed left-0 top-0 z-1 h-full w-75 border-r border-gray-300 bg-white transition-transform duration-300 dark:border-gray-500 dark:bg-zinc-700 ${!isMenuVisible && "-translate-x-full"}`}
      >
